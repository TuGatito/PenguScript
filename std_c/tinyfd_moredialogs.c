...
/* PenguScript vendoring note: upstream ships this file one directory below
 * tinyfiledialogs.h; both live flat in std_c/ here, so the include was
 * changed from "../tinyfiledialogs.h" to "tinyfiledialogs.h". */
