...
def test_version_sync_0_13_10():
    ...
    assert pengu_version.__version__ == "0.13.10"
    assert pengu_version.FALLBACK_VERSION == "0.13.10"
    assert PENGU_VERSION == "0.13.10"
    assert pengu_version.read_version_file() == "0.13.10"
