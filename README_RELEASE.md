...
├── pengus-0.2.0.vsix         # VS Code Extension (Syntax, LSP, Go-To-Definition, Cargo Commands)
...
4. Select **Install from VSIX...** and choose `D:\Proyectos\PenguScript\pengucc_build\pengus-0.2.0.vsix`.
